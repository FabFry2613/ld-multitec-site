    ...
    <Layout>
      ...
      >
        <img
          ...
          className="absolute inset-0 w-full h-full object-cover opacity-60 service-hero-img"
        />
      ...
      <section className="py-16 md:py-20" style={{ backgroundColor: "#F7F8FA" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-4 md:gap-0">
            {data.method.map((m, i) => (
              <FadeIn key={i} className="flex-1 w-full md:w-auto">
                <div className="flex flex-col items-center text-center px-4">
                  <div
                    className="w-14 h-14 rounded-full flex items-center justify-center text-xl font-bold text-white mb-4 method-step-badge"
                    style={{ backgroundColor: "#D4550A" }}
                  >
                    {m.step}
                  </div>
